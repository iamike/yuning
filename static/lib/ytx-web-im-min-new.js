(function(e) {
    try {
        if (typeof(hex_md5) == "undefined") {
            document.write('<script type="text/javascript" src="https://app.cloopen.com/im50/MD5.min.js"><\/script>')
        }
    } catch(e) {
        document.write('<script type="text/javascript" src="https://app.cloopen.com/im50/MD5.min.js"><\/script>')
    }
    try {
        if (!Base64 || typeof(Base64) == "undefined") {
            document.write('<script type="text/javascript" src="https://app.cloopen.com/im50/base64.min.js"><\/script>')
        }
    } catch(e) {
        document.write('<script type="text/javascript" src="https://app.cloopen.com/im50/base64.min.js"><\/script>')
    }
    try {
        if (!jQuery || typeof(jQuery) == "undefined") {
            document.write('<script type="text/javascript" src="https://app.cloopen.com/im50/jquery-1.11.3.min.js"><\/script>')
        }
    } catch(e) {
        document.write('<script type="text/javascript" src="https://app.cloopen.com/im50/jquery-1.11.3.min.js"><\/script>')
    }
    try {
        if (!pako || typeof(pako) == "undefined") {
            document.write('<script type="text/javascript" src="https://app.cloopen.com/im50/pako.js"><\/script>')
        }
    } catch(e) {
        document.write('<script type="text/javascript" src="https://app.cloopen.com/im50/pako.js"><\/script>')
    }
    var YTX_CONFIG = {
        _lvs_servers: ['aHR0cHM6Ly9qc2Rvd24uY2xvb3Blbi5jb206ODg5OQ'],
        _server_ip: ['d3NzOi8vamF2YXNvY2tldC5jbG9vcGVuLmNvbTo4MTg4L3dz'],
        _file_server_url: 'd3NzOi8vamF2YXNvY2tldC5jbG9vcGVuLmNvbTo4MTg4L3dz',
        _socket: null,
        _appid: '',
        _version: '5.2.1r5',
        _ClientNo: 0,
        ...
        _processSyncMsg: function(type, endVersion, requestType) {
            ...
            if ( !! endVersion && endVersion < YTX_CONFIG._maxMsgVersion) {
                ...
                var sendStr = YTX_CONFIG._protobuf._buildSyncMessage(YTX_CONFIG._msgVersion + 1, endVersion, type,
                function() {});
                if ( !! sendStr) {
                ...
                if (YTX_CONFIG._msgVersion != YTX_CONFIG._maxMsgVersion) {
                    var sendStr = YTX_CONFIG._protobuf._buildSyncMessage(YTX_CONFIG._msgVersion + 1, end, 0,
                    function() {});
                    if ( !! sendStr) {
                        YTX_CONFIG._syncMsgPorcessing = true;
                        YTX_CONFIG._sendMsg(sendStr)
        ...
        _processVoip: function(callEventData) {
            ...
            if (callEventData.getCallEvent() == 1) {
                ...
                resp.code = 200;
                YTX_CONFIG._voipListener(resp)
            } else if (callEventData.getCallEvent() == 6) {} else if (callEventData.getCallEvent() == 7 || callEventData.getCallEvent() == 8) {
                var resp = {};
                resp.callId = callEventData.getCallId();
                resp.caller = callEventData.getCaller();
                resp.called = callEventData.getCalled();
        ...
        _protobuf: {
            ...
            _buildDeleteReadMsg: function(DeleteReadMsgBuilder, callback, onError) {
                ...
                sendJsonStr = JSON.stringify(sendJsonStr);
                var sendProto = '{\"DeleteReadMsg\":' + sendJsonStr + '}';
                var clientNo = YTX_CONFIG._generateClientNo(callback, onError);
        ...
        _sendVoip: function(CallEventBuilder, callback, onError) {
            ...
            pc.onaddstream = function(event) {
                ...
                if (YTX_CONFIG._voipCallData._voipOtherView.mozSrcObject != undefined) {
                    YTX_CONFIG._voipCallData._voipOtherView.mozSrcObject = event.stream
                } else if ( !! windowUrl) {
                    YTX_CONFIG._voipCallData._voipOtherView.src = windowUrl.createObjectURL(event.stream)
                }
            };
        ...
        util: {
            ...
            getSessionDescription: function() {
                var sessionDescription = window.mozRTCSessionDescription || window.RTCSessionDescription || window.webkitRTCSessionDescription || window.msRTCSessionDescription;
    ...
    window.RL_YTX = window.RL_YTX || {
        ...
        login: function(LoginBuilder, callback, onError) {
            ...
            YTX_CONFIG._initScoket(LoginBuilder.getType(), callback, onError, LoginBuilder.getSig(), LoginBuilder.getTimestamp(), true)
        },
        ...
        makeCall: function(MakeCallBuilder, callback, onError) {
            ...
            var us_data = "tel=" + MakeCallBuilder.getTel();
            var CallEventBuilder = new YTX_CONFIG._protobuf._CallEventData(1, callId, MakeCallBuilder.getCallType(), MakeCallBuilder.getCalled(), YTX_CONFIG._userName, us_data, MakeCallBuilder.getNickName());
